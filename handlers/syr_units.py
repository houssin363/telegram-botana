...
def register(bot, user_state):
    ...
    def select_syriatel_product(msg):
        ...
        kb.add(types.InlineKeyboardButton("⬅️ رجوع", callback_data="syr_back"))
        bot.send_message(msg.chat.id, "📲 أدخل الرقم أو الكود (يبدأ بـ 093 أو 098 أو 099):", reply_markup=kb)
